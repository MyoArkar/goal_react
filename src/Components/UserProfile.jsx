    ...
    return (
        ...
        >
            <div className="min-w-[3.5rem] h-[3.5rem]">
                <img src={user} alt="profile" className='w-full h-full rounded-full object-cover' />
            </div>
            <div className={`flex flex-col justify-center ${open ? "" : "opacity-0 duration-200 delay-100"} `}>
                <h2 className='
                text-[1.1rem]'>Alex</h2>
