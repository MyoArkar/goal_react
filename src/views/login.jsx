    ...
    <div className="min-h-screen bg-gray-900 flex items-start justify-center">
      <div className="mt-10 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <div className="mt-4 text-gray-600 text-xl font-bold">
          ...
          <p className="relative text-center before:content-[''] before:block before:w-[45%] before:h-1 before:rounded-full before:bg-gray-600 before:absolute before:left-0 before:top-1/2 after:content-[''] after:block after:w-[45%] after:h-1 after:rounded-full after:bg-gray-600 after:absolute after:right-0 after:top-1/2">OR</p>
        </div>
        <button
          className="text-xl font-bold w-full text-sky-500 py-4 px-4 rounded-xl border-2 border-b-4 border-gray-600 transition-colors duration-300 mt-4"
        >
        <Link
              to="/register"
