    ...
    return (
        <div className='w-[1100px] bg-slate-50  mx-auto p-10 flex flex-col gap-10'>
            ...
            <div className='flex flex-row justify-center w-full rounded-md item border-2 border-sky-500 '>
                <button className=' pt-1 pl-3 rounded-l-md'>
                    <ion-icon name="search-circle-outline" className="" style={{ color: 'black', fontSize: '25px' }}></ion-icon>
                </button>
                <input type="text" name="search" id="" className='w-full  py-2 px-1 rounded-r-md outline-none text-slate-300 flex' placeholder='Search goal...' />
            </div>
